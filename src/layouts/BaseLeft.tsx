...
import { AntDesignOutlined, SmileOutlined, TableOutlined } from '@ant-design/icons';
...
const items = [
  {
    ...
    children: [{ label: 'Eslint & Prettier', key: 'eslint-prettier' }],
  },
  {
    label: 'Ant Design',
    key: 'antd',
  ...
  },
  {
    ...
    key: 'msw',
    icon: <SmileOutlined />,
    children: [{ label: 'About', key: 'about-msw' }],
  },
];
  ...
  return (
    <Sider width={256} collapsible collapsed={collapsed} onCollapse={toggleCollapsed} className="site-layout-background" theme={theme}>
      <Space direction="vertical" size="middle" style={{ display: 'flex' }}>
        <Menu defaultSelectedKeys={['1']} defaultOpenKeys={['tui-grid']} mode="inline" theme={theme} items={items} onClick={onClick} />
